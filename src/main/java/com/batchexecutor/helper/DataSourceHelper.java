...
public class DataSourceHelper {
    ...
    public static Connection getConnection(boolean isAutoCommit) throws SQLException {
        return new ConnectionWrapper(mainDataSource.getConnection(), isAutoCommit);

    }


    public static final class ConnectionWrapper implements Connection {
        private final Connection conn;
        private final String connId;
        String sql = "";

        public ConnectionWrapper(Connection conn, boolean isAutoCommit) throws SQLException {
            this.conn = conn;
